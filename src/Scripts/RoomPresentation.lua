function StartRoomPresentation(currentRun, currentRoom, metaPointsAwarded)
    ...
    if AsphodelBoatSoundId ~= nil and currentRoom.EntranceFunctionName ~= "AsphodelEnterRoomPresentation" and currentRoom.EntranceFunctionName ~= "RoomEntranceBossHydra" then
        -- @hack
